...
def run_full_canonical_promotion(
    ...
    *,
    ...
    prepared = prepare_canonical_promotions(
        ...
        bodywork_canonical=canonical_bodywork_by_kt086(connection),
        drive_labels=official_drive_type_labels(reference_directory),
        drive_canonical=canonical_drive_by_kt082(connection),
