...
def test_mode_defaults_to_dry_run_and_accepts_a_positional_override() -> None:
    ...
    defaulted = MatchRunPins(uuid4(), "TS", "v1", "batch", 10, "rules", "catalog", "policy", "sha")
    assert defaulted.mode is MatchRunMode.DRY_RUN
