...
- Added `docs/PR_11_APPROACH_PLAN.md` with the focused revision scope, merge gates, and SCRUM-13/14/15 follow-up sequence for PR #11; validation: Markdown diff check; next step: apply the plan to PR #11 before merge.
