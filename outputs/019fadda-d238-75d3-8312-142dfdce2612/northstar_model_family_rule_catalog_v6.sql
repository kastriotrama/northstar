-- NorthStar reviewed model-family catalog activation
-- Baseline database version: ts-review-20260807T142843182320Z
-- Target database version: ts-review-20260807T145505493277Z
-- Target base catalog: ts-translation-v6
--
-- The matching application supplies MOD-001..MOD-025 for the reviewed high-volume
-- Volkswagen, Volvo, Kia, Toyota, Skoda, Nissan, Renault, Ford and Tesla families.
-- Every rule is manufacturer-scoped and uses a complete prefix/token boundary.
-- This phase does not use TecDoc and does not infer a model when TS Model is absent.
...
DECLARE
    baseline_version CONSTANT text := 'ts-review-20260807T142843182320Z';
    target_version CONSTANT text := 'ts-review-20260807T145505493277Z';
    expected_baseline_catalog CONSTANT text := 'ts-translation-v5';
    target_catalog CONSTANT text := 'ts-translation-v6';
    target_note CONSTANT text := 'Approved manufacturer-scoped model-family rules MOD-001 through MOD-025 without TecDoc inference';
    target_activated_at CONSTANT timestamptz := '2026-08-07T14:55:05.493277+00:00';
...
SELECT
    ...
    activated_at
FROM core.translation_rule_versions
WHERE version = 'ts-review-20260807T145505493277Z';
